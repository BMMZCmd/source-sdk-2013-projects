...
void CBaseViewModel::CalcIronsights(Vector& pos, QAngle& ang)
{
	...
	float delta = (gpGlobals->curtime - pWeapon->m_flIronsightedTime) * pWeapon->GetWpnData().flIronsightAnimTime; //modify this value to adjust how fast the interpolation is
